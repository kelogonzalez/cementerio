...
if(mysql_num_rows($busca))
 {   
	...
	echo "<form method='post' action='' onsubmit='enviarDatosPrestamo(); return false' name='registro_prestamo'>
		<center><b><h3>Registro de Prestamo</h3></b><br>
		<table><tr><td>
		...
		<tr><td>Fecha </td> <td><input type='text' name='Fecha_prestamo' readonly='readonly' value='$hoy'><br></td></tr>
		<tr><td>Codigo del Libro</td> <td><input type='text' name='Codigo'><br></td></tr>
		<tr><td><input type='submit' value='Registrar' name='Registrar'/></td> <td>
...
<div id="busqueda">
<center>
<form name="cambios" action="prestamo.php" method="POST">
