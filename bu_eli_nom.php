...
<title>Eliminacion Por Nombres</title>
...
if(isset($_POST['enviar']))	//Aqui el codigo PHP Y REVISAMOS SI NO "PINCHARON EL BOTON DE BUSCAR DEL FORMULARIO QUE ESTA MAS ABAJO DEL CODIGO"
 {
 	...
 	$aut=$_POST['Autor'];//Sacamos de la variable POST y lo almacenamos en la veriable $tit
$buscar=mysql_query("SELECT * FROM libros WHERE Autor LIKE '%$aut%'"); //Busqueda por medio de la Titulo(CONSULTA MYSQL)
...
<div id="tabla_pres"> <!--INICIAMOS EN HTML UNA TABLA PARA POSTEAR LOS RESULTADOS DE LA CONSULTA(busqueda)-->
 <table align="center">
<tr bgcolor="#8B0000" align="center"><td><font color="white">ID</font></td><td><font color="white">Sector</font></td><td><font color="white">Bloque</font></td><td><font color="white">Nombres</font></td><td><font color="white">Fecha de Fallecido</font></td></tr>
<?php
...
<center>
	<h3>Busqueda</h3>
<form name="cambios" action="bu_eli_nom.php" method="POST"> <!--!ESTE ES OTRO FOMULARIO DONDE REALIZAREMOS LA BUSQUEDA POR TITULO-->
Nombres <input type="text" name="Autor" /><br>
