...
if(mysql_num_rows($busca))
 {   
	...
	echo "<form method='post' action='' onsubmit='modificarDatosPrestamo(); return false' name='modificar_prestamo'>
		<center><b><h3>Entrega de Libros</h3></b><br>
		<table><tr><td>CURP</td> <td><input type='text' name='curp' readonly='readonly' value='".$cu."'> <br></td></tr>
		...
		<tr><td>Codigo del Libro A Entregar</td> <td><input type='text' name='Codigo'><br></td></tr>
		<tr><td><input type='submit' value='Registrar' name='Entregar'/></td> <td>
 ...
 $seleccionar_c = "SELECT * FROM libros join prestamos on libros.Codigo=prestamos.Codigo and prestamos.curp='$cu'";
$mostrar_c= mysql_query($seleccionar_c, $conectar) or die('Capture el Codigo del Libro');
?>
<div id="tabla_pres">
 <table align="center">
<tr bgcolor="#800000" align="center"><td><font color="white">Codigo</font></td><td><font color="white">Titulo</font></td><td><font color="white">Autor</font></td><td><font color="white">Editorial</font></td><td><font color="white">Fecha de Prestamo</font></td><td><font color="white">Fecha Entrega</font></td></tr>
<?php
...
<td align="center"><?php echo $row_mostrar_seleccion_c['Fecha_devolucion'] ?></td>
<?php }?>
</table>
</div>
<?php
...
<div id="busqueda">
<center>
<form name="cambios" action="entrega.php" method="POST">
